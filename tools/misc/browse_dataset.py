...
def parse_args():
    ...
    parser.add_argument('--config',default='/project/luojunwei/test4/mmrotate/configs/bridge_benchmark/oriented_rcnn_r50_fpn_2x_BridgeDetV_oc.py', help='train config file path')
    parser.add_argument(
        '--skip-type',
        type=str,
        nargs='+', 
        # default=['Normalize'],
        default=['DefaultFormatBundle', 'Normalize', 'Collect','RRandomFlip'],  #去除随机翻转等
        help='skip some useless pipeline')
    parser.add_argument(
        '--output-dir', #输出目录
        default='/scratch/luojunwei/Browse_dataset/DIOR_GT',
        #type=str,
